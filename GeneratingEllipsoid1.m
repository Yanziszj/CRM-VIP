function [C_new ,Salter_ponit] = GeneratingEllipsoid1(n,m)
%% This file to generate m ellipsoids in R^n
% in this file we generate m ellipsoid in the form of 
% E: = \{x \in R^n: x' A x+2b' x \leq \alpha \}
% 
% remark: we gentenate ellipsoids with non-empty interior and 
%   p is always a Slater point



%%  Input: 
%   n: the dimension,
%   m: the number of ellipsoid


%%  Output: C is a cell containing all the example
%   C_new(1,i) is the positive definite matrix A
%   C_new(2,i) is the vector b 
%   C_new(3,i) is the alpha.
%   p is the slater point.
